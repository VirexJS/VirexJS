...
[![Tests](https://img.shields.io/badge/tests-1092%20passing-brightgreen)](https://github.com/virexjs/virexjs)
...
- **Cross-island communication** — Shared store + event bus between islands (v0.2)
...
bun test                 # Run 1092 tests (98 files)
