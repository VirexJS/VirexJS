...
export default function Register(_props: PageProps) {
	const head = useHead({ title: "Register" });
	...
	return (
		<div style={{ maxWidth: "380px", margin: "80px auto", padding: "0 16px", fontFamily: "system-ui" }}>
			{head}
			<h1 style={{ fontSize: "24px", textAlign: "center", margin: "0 0 24px" }}>Create Account</h1>
			<div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
				<div>
					<label htmlFor="name" style={{ display: "block", marginBottom: "6px", fontSize: "14px", fontWeight: "500" }}>Name</label>
					<input id="name" type="text" placeholder="Your name" style={input} />
				</div>
				<div>
				...
				<div>
					...
					<input id="password" type="password" placeholder="Min 6 characters" style={input} />
				</div>
